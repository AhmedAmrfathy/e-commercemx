...
class AuthScreen extends StatelessWidget {
  static const routeName = 'authoroute';
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  ...
                  Color.fromRGBO(255, 255, 100, 1).withOpacity(0.9),
                ],
                  ...
                  Flexible(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Color.fromRGBO(255, 255, 160, 1),
                        boxShadow: [
                          BoxShadow(
                            blurRadius: 8,
...
class _AuthCardState extends State<AuthCard>
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      Navigator.of(context).pushReplacementNamed(ProductOvverViewScreen.route);
              ...
              children: <Widget>[
                ...
                if (_isLoading)
                  ...
                  RaisedButton(
                    ...
                    color: Color.fromRGBO(255, 255, 100, 1).withOpacity(0.9),
